...
export default function CreateAnnouncement() {
  ...
  return (
    <section>
      {showMessage && (
        <p className="p-2 text-emerald-500 bg-emerald-200">
          Annuncio creato con successo
        </p>
      )}
      <div className=" flex justify-center items-center my-10">
        <form className="p-8 rounded-lg shadow-lg" action={submitAction} ref={form}>
          ...
          <div className="flex flex-col mt-8">
            <label htmlFor="type" className="my-2 text-sm">
            ...
            <div className="mt-10">
              <button
                type="submit"
                className="w-full p-2 uppercase text-white bg-emerald-500 rounded"
              >
                inserisci annuncio
              </button>
            </div>
